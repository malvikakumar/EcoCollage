      ...
      var heatmapChart = function(csvFile) {
        ...
        function(error, data) {
          ...
          var cards = svg.selectAll(".hour")
              .data(data, function(d) {return d.xcoord+':'+d.ycoord;});

          cards.append("title");

          cards.enter().append("rect")
              .attr("x", function(d) { console.log(d.ycoord); return (d.xcoord) * gridSize; })
              .attr("y", function(d) { console.log(d.xcoord); return (d.ycoord) * gridSize; })
              .attr("rx", 4)
              .attr("ry", 4)
